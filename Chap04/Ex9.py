...
# compactness를 증가시킴에 따라 픽셀의 모양이 더 정밀해지는 것을 확인할 수 있다.
# n_segments를 증가킴에 따라 분할된 픽셀의 수가 증가하는 것을 확인할 수 있다.
# 따라서 compactness와 n_segments를 조절하여 적절한 값으로 분할하는 것이 중요하다